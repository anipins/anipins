...
public class MainActivity extends Activity {
    ...
    private View createGrid() {
        swipe = new SwipeRefreshLayout(this); swipe.setColorSchemeColors(Ui.GOLD); RecyclerView list = new RecyclerView(this); list.setBackgroundColor(Ui.INK); list.setPadding(Ui.dp(this,10),Ui.dp(this,4),Ui.dp(this,10),Ui.dp(this,20)); list.setClipToPadding(false); list.setHasFixedSize(false); list.setItemViewCacheSize(8); list.setDrawingCacheEnabled(false); list.setOverScrollMode(View.OVER_SCROLL_NEVER);
