...
export default function Privacy() {
  return (
    <section className="mx-auto max-w-3xl px-6 pt-28 text-sm leading-7 text-fog md:pt-32">
      ...
      <p className="mt-3">AniPins uses Vercel for website and API hosting and Supabase infrastructure for the production database and image storage. These providers process data on our behalf to operate the service. The current Android release does not include advertising, analytics or push-notification SDKs. We do not sell personal information or rent user lists.</p>
