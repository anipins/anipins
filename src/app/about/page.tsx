...
export default function AboutPage() {
  return <section className="mx-auto max-w-3xl px-6 pt-28 text-sm leading-7 text-fog md:pt-32">
    ...
    <p className="mt-6">AniPins is an independent discovery platform for browsing anime and manhua artwork references, following favorite characters and series, and keeping private collections in sync across the website and native Android app.</p>
    ...
    <p className="mt-3">AniPins brings character discovery, themed collections, high-quality downloads and a personalized visual feed into one focused experience. It is built for drawing reference, sketch practice, character study and creative inspiration. Visitors can browse without an account, while signed-in users can keep profiles, follows, likes, saves and collections synchronized across devices.</p>
    <h2 className="mt-8 font-display text-2xl font-semibold text-paper">Independent and community-minded</h2>
    <p className="mt-3">AniPins is independently operated and is not an official product of any anime studio, publisher or franchise owner. Characters and source material belong to their respective rights holders. Artwork may be used as visual reference for personal study and sketch practice; it may not be copied, reposted or used commercially without permission from the relevant rights holder. Artwork publishing is limited to authorized administrators, and every visitor can report inaccurate, inappropriate or potentially infringing content.</p>
