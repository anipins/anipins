...
export default function Logo({ compact = false, responsive = false }: { compact?: boolean; responsive?: boolean }) {
  return (
    <Link href="/" className="group flex items-center gap-2.5 shrink-0" aria-label="AniPins home">
      <img src="/brand/ap-symbol-192.png" alt="" className="block h-9 w-9 rounded-[10px] object-contain object-center transition-shadow duration-300 group-hover:shadow-[0_0_18px_rgba(198,161,91,0.35)]" />
      {!compact && (
