...
declare global { interface Window { AniPinsAndroid?: { haptic?: (kind: string) => void; openDownloads?: () => void; getVersionCode?: () => number; showNotification?: (title: string, body: string, url: string) => void; signInWithGoogle?: (nonce: string) => void; openGoogleBrowserLogin?: () => void } } }
