...
3. Upload `release/AniPins-2.1.0.aab` to an internal test track.
...
6. Set privacy URL to `https://anipins.com/privacy`.
7. Set account-deletion URL to `https://anipins.com/delete-account`.
...
- Sideload APK: `release/AniPins-2.1.0.apk`
- Play upload bundle: `release/AniPins-2.1.0.aab`
